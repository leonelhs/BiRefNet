#
# This config file is needed for convert models to onnx runtime, and it was generated by:
# https://github.com/ZhengPeng7/BiRefNet/blob/main/tutorials/BiRefNet_pth2onnx.ipynb
# To use it, replace temporally into config.py meanwhile convert_onnx.py performs it models conversions
#
